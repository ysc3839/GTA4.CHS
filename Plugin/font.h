...
public:
    ...
    static bool IsNaiveCharacter(std::uint16_t);

    static float GetCharacterSizeNormalDispatch(std::uint16_t);
    static float GetCHSCharacterSizeNormal();

    static float GetCharacterSizeDrawingDispatch(std::uint16_t, bool);
    static float GetCHSCharacterSizeDrawing(bool);

    static std::uint16_t* SkipAWord(std::uint16_t*);
